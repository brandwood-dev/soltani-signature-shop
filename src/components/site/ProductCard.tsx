    ...
    <article className="group relative">
      <div className="relative aspect-square overflow-hidden bg-card shadow-sm dark:shadow-none rounded-sm">
        ...
        <div className="absolute inset-x-3 bottom-3 flex gap-2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
          <button className="flex-1 inline-flex items-center justify-center gap-2 h-10 bg-gold text-ink text-[11px] uppercase tracking-widest font-semibold hover:bg-ink hover:text-gold transition rounded-sm">
            <ShoppingBag className="h-3.5 w-3.5" /> Ajouter
          </button>
          <button aria-label="Quick view" className="grid h-10 w-10 place-items-center bg-background/85 backdrop-blur text-foreground border border-gold/30 hover:text-gold rounded-sm">
