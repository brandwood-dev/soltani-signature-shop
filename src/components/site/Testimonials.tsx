...
export function Testimonials() {
  return (
    <section className="py-24 md:py-32 bg-ink/40">
      <div className="container-luxe">
        <div className="text-center mb-14">
          <span className="text-[11px] uppercase tracking-[0.4em] text-gold">Avis Clients</span>
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 text-cream">
            Ils nous font <span className="italic font-light text-gold">confiance</span>
          </h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {TESTS.map((t) => (
            <div key={t.name} className="p-8 bg-card border border-gold/15 hover:border-gold/40 transition rounded-sm relative">
              ...
              <p className="text-cream/85 mb-6 leading-relaxed">"{t.text}"</p>
