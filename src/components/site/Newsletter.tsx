  ...
  return (
    <section className="py-24 md:py-32 bg-background">
      <div className="container-luxe">
        <div className="relative overflow-hidden border border-gold/30 rounded-sm p-10 md:p-16 text-center bg-gradient-to-br from-ink to-card">
          ...
          <div className="relative">
            ...
            <form className="max-w-md mx-auto flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 h-12 px-4 bg-secondary border border-gold/20 text-cream placeholder:text-muted-foreground focus:outline-none focus:border-gold transition rounded-sm"
              />
              <button className="h-12 px-6 bg-gold text-ink text-[11px] uppercase tracking-[0.25em] font-semibold hover:bg-gold-soft transition rounded-sm">
                S'inscrire
              </button>
            </form>
