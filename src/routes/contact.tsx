      ...
      <section className="container-luxe py-16 grid lg:grid-cols-2 gap-12">
        <div className="space-y-6">
          {[{ I: MapPin, t: "Showroom Tunis", d: "Avenue Habib Bourguiba, Tunis 1000" },
            { I: Phone, t: "Téléphone", d: CONTACT_PHONE_DISPLAY, href: `tel:${CONTACT_PHONE_TEL}` },
            { I: MessageCircle, t: "WhatsApp", d: CONTACT_PHONE_DISPLAY, href: CONTACT_WHATSAPP_URL },
            { I: Mail, t: "Email", d: "contact@soltanisignature.com" },
            { I: Clock, t: "Horaires", d: "Lun-Sam · 9h-19h · Dim sur RDV" }].map(({ I, t, d, href }) => (
            <div key={t} className="flex items-start gap-4 p-5 bg-secondary/40 border border-border rounded-sm">
              ...
              <div>
                ...
                {href ? (
                  <a href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noopener noreferrer" : undefined} className="text-foreground hover:text-gold transition">
                    {d}
                  </a>
                ) : (
