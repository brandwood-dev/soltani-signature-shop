...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "application-name", content: "Soltani Signature" },
      { name: "apple-mobile-web-app-title", content: "Soltani" },
...
function RootShell({ children }: { children: ReactNode }) {
  const metaPixelBootstrap = `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version="2.0";n.queue=[];t=b.createElement(e);t.id="meta-pixel-script";t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");window.fbq("init","${publicEnv.metaPixelId}");window.fbq("track","PageView");window.__soltaniMetaPixelLoaded=true;window.__soltaniInitialPageViewTracked=true;`;
