...
function RootShell({ children }: { children: ReactNode }) {
  const metaPixelBootstrap = `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version="2.0";n.queue=[]}(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");window.fbq("init","${publicEnv.metaPixelId}");window.__soltaniMetaPixelLoaded=true;`;
  ...
  return (
    <html lang="fr">
      <head>
        ...
        <script id="meta-pixel-script" async src="https://connect.facebook.net/en_US/fbevents.js" />
      </head>
