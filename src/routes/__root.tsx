...
const themeInitScript = `(function(){try{var t=localStorage.getItem('soltani-theme');if(!t)t='dark';if(t==='dark')document.documentElement.classList.add('dark');}catch(e){document.documentElement.classList.add('dark');}})();`;
